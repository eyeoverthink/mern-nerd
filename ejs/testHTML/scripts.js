document.addEventListener("DOMContentLoaded", function() {
    ...
    colorPicker.addEventListener("input", function() {
        ...
        // Optionally, add this style to styleMap
        const command = `vs-text-custom-${color.replace('#', '')}`;
        styleMap[command] = `color: ${color};`;
        displayCommands();
        saveStyleMap();
    });
    ...
    textSizeSlider.addEventListener("input", function() {
        ...
        // Optionally, add this style to styleMap
        const command = `vs-text-size-${size.replace('px', '')}`;
        styleMap[command] = `font-size: ${size};`;
        displayCommands();
        saveStyleMap();
    });
